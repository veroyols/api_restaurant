...
namespace UnitTest.Application.UseCase
{
    public class Class1
    {
        ...
        public void ComandaMercaderiaExistTest()
        {

        }
        
        //public Task<MercaderiaResponse?> GetMercaderiaById(int id);
        public void GetMercaderiaByIdTest()
        {

        }
        
        //public Task<bool> Exist(List<int> mercaderias);
        public void ExistByListTest()
        {
